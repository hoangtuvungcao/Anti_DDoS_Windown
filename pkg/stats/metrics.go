...
type Metrics struct {
	...
	Layer1Drops atomic.Uint64 // Garbage filter
	Layer2Drops atomic.Uint64 // Port not listening
	Layer3Drops atomic.Uint64 // TCP shield
	Layer4Drops atomic.Uint64 // UDP rate limit
...
func (m *Metrics) TotalDrops() uint64 {
	return m.SnapL1 + m.SnapL2 + m.SnapL3 + m.SnapL4
}
